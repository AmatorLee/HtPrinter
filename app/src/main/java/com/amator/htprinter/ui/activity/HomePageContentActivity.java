...
public class HomePageContentActivity extends BaseActivity<ContentActivityPresenterImpl> implements ContentView, ActionSheetDialog.OnSheetItemClickListener {

    public static final String TAG = HomePageContentActivity.class.getSimpleName();
    ...
    protected void setListener() {
        ...
        if (intent != null) {
            this.homePahe = (HomePage) intent.getSerializableExtra("homePage");
            if (homePahe != null && !TextUtils.isEmpty(homePahe.getLink())) {
                loadUrl(homePahe.getLink());
            } else {
                finish();
            }
        } else {
